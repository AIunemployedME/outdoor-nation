...
if ((typeof SECOMAPP) == 'undefined') {
    ...
    SECOMAPP.pl.labels = [
            ...
            'priority': 0,
            'hide': 0,
            'image': 'https://d3azqz9xba9gwd.cloudfront.net/storage/labels/outdoor-nation-2022/65283ef432c8a.jpeg',
                        'position': 'top_left',
            'styles': '',
            'text_styles': '',
            'label_width': 30,
    ...
    SECOMAPP.pl.labelCollections = function (force) {
        ...
        searchCallback = function (json) {
            ...
            if (json.results_count > 50 && ((typeof SECOMAPP.pl.search) == 'undefined' || !SECOMAPP.pl.search.hasOwnProperty(json.query))) {
                ...
                for (var page = 2; page <= Math.floor((json.results_count + 49) / 50); page++) {
                    ...
                    jQuery.getScript('/search.js?page=' + page + '&q=' + query + '&view=scm.products.handle.js&_sc=1&design_theme_id=137338487100&app=pl');
                }
            }
        };
        ...
        for (var handle in productImages) {
            ...
            h++;
            if (h >= 50) {
                jQuery.getScript('/search.js?q=' + fullQuery + '&view=scm.products.handle.js&_sc=1&design_theme_id=137338487100&app=pl');
                fullQuery = "";
                h = 0;
            }
        }
